...
public class Main {
    ...
    public static void visualizarClienteAtual(Cliente clienteAtual){
        ...
        RegistroDeClientes.getInstancia().visualizarDetalhesDaAvaliacao(clienteAtual.getCpf());
        System.out.println("------------------------------------------------");
    }
    public static void main(String[] args) throws InterruptedException, IOException, ClassNotFoundException {
        ...
        RegistroDeClientes.getInstancia().construirAvaliacoes();
        RegistroDeClientes.getInstancia().printarListaDeClientes();
            while (decisao == 1 || decisao == 2 || decisao == 3 || decisao == 4 || decisao == 5 || decisao == 6 || decisao == 7 || decisao == 8 || decisao == 9 || decisao == 10 || decisao == 11 || decisao == 12 || decisao == 13 || decisao == 14 || decisao == 15 || decisao == 16 || decisao == 17 || decisao == 18 || decisao == 19 || decisao == 30){
                ...
                try {
                    ...
                    switch (decisao){
                        ...
                        case 19: // EXIBIR DADOS DO BANCO
                            ...
                            break;
                        case 30: //INSERIR AVALIACAO
                            try {
                                if(clienteAtual.getCpf() == null){
                                    throw new YouAreNotLoggedInException();
                                }
                                RegistroDeClientes.getInstancia().inserirAvaliacao(clienteAtual);
                                RegistroDeClientes.getInstancia().atualizarCliente(clienteAtual);
                                ArquivoAvaliacao.getInstancia().atualizarArquivo(clienteAtual);
                            }catch (YouAreNotLoggedInException e){
                                System.out.println(e.getMessage());
                            }
                            break;
